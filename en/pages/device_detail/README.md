...
#### 1. OTA function
 #####**Access required**: [Access OTA Service Package](http://aa "Access OTA Service Package")

#### 2. FAQ and feedback function
 #####**Access required**: [Access Help Center Business Package](https://registry.code.tuya-inc.top/TuyaIOSBusinessSDK/tuyasmartbizbundledoc/tree/master/zh-hans/pages/ faq "Access Help Center Service Package")

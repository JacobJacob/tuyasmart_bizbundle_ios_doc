...
#### 1.  OTA功能
 #####**需要接入**：[接入OTA业务包](http://aa "接入OTA业务包")

#### 2.  常见问题与反馈功能
 #####**需要接入**：[接入帮助中心业务包](https://registry.code.tuya-inc.top/TuyaIOSBusinessSDK/tuyasmartbizbundledoc/tree/master/zh-hans/pages/faq "接入帮助中心业务包")
